      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
        ...
        <div className="availability-list" style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          {filteredUnits.length > 0 ? filteredUnits.map((unit) => {
              ...
              <React.Fragment key={unit.id}>
                ...
                >
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '32px', borderLeft: '1px solid var(--border-color)', paddingLeft: '32px', minWidth: '220px' }}>
                    ...
                    <div>
                      <div style={{ fontSize: '11px', textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--text-secondary)', marginBottom: '8px', fontWeight: '600' }}>Status</div>
                      <span style={{ 
                ...
                {isSelected && (
                  <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '16px', padding: '32px', marginTop: '-8px', marginBottom: '8px' }}>
                    <div className="financing-panel">
                      <div className="financing-left">
                        <h3 style={{ margin: '0 0 16px 0', fontSize: '18px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--accent-color)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
                          Live Financing
                        </h3>
            ...
            <div style={{ padding: '48px', textAlign: 'center', color: 'var(--text-secondary)', background: 'var(--bg-panel)', borderRadius: '16px' }}>
